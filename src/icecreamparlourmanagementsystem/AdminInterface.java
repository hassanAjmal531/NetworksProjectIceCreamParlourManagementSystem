...
public class AdminInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        addFlavour = new javax.swing.JButton();
        ...
        addFlavour.setText("Add New Flavour");
        addFlavour.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addFlavourActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(price)
                            .addComponent(stock)))
                    .addComponent(addFlavour, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void addFlavourActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addFlavourActionPerformed
        // TODO add your handling code here:
        try{
           int id = Integer.valueOf( this.id.getText());
           String flavour = this.flavour.getText();
           int price = Integer.valueOf(this.price.getText());
           int stock = Integer.valueOf(this.stock.getText());


          boolean check = new Admin().addFlavour(new IceCream(id, flavour,price, 1, stock), 1);
          
          if(check){
             JOptionPane.showMessageDialog(rootPane, "data added successfully in the database"); 
          }
    ...
    }//GEN-LAST:event_addFlavourActionPerformed

    private void searchbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchbtnActionPerformed
        // TODO add your handling code here:
        try{
            int id = Integer.valueOf( this.search.getText());
            Document doc = new Admin().search(new IceCream(id,2), 2);
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
        // TODO add your handling code here:
        try{
           ArrayList<IceCream> record = new Admin().view();
           DefaultTableModel model = (DefaultTableModel) this.jTable1.getModel();
           model.setRowCount(0);
    ...
    private javax.swing.JButton addFlavour;
